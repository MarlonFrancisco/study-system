  ...
  <v-dialog v-model="dialog" persistent max-width="600px">
    <v-card>
      ...
      <v-card-text>
        ...
        ----
        VISÃO GERAL
        Esse site é operado pelo Liga dos estudantes. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Liga dos estudantes. O Liga dos estudantes proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.
        ...
        Esses Termos de serviço e quaisquer acordos separados em que nós lhe fornecemos os Serviços devem ser regidos e interpretados de acordo com as leis de rua quinze de novembro, são bernardo do campo, SP, 09781941, Brazil.
        ...
        As perguntas sobre os Termos de serviço devem ser enviadas para nós através do marlon@biggy.com.br.
      </v-card-text>
      <v-card-actions>
...
export default class Terms extends Vue {
  @Prop(Boolean) private dialog = false;
