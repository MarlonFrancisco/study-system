<template>
    <div>
        ...
        <v-card-actions>
            <v-btn color="teal" class="mx-auto text-capitalize" width="100%" elevation="1" @click="login">Entrar</v-btn>
        </v-card-actions>
        ...
        <v-card-actions>
            <v-btn elevation="0" color="transparent" class="mx-auto text-capitalize" @click="recovery">Esqueceu a senha?</v-btn>
        </v-card-actions>
    </div>
</template>
